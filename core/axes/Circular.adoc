/**
 * Circular axis class.
 * {docs:Gauges/Circular_Gauge#axis}Learn more about circular ticks.{docs}
 ...
 * @param {(Object|boolean|null)=} opt_value [false] Ticks settings.
 * @return {anychart.core.axes.Circular} Self instance for method chaining.
 */
anychart.core.axes.Circular.prototype.ticks;
 ...
 * @param {(anychart.graphics.vector.Fill|string)} value ["black 0.3"] Color as an object or a string.
 * @return {anychart.core.axes.Circular} Self instance for method chaining.
 */
anychart.core.axes.Circular.prototype.fill;
...
/**
 * Getter for labels overlaps mode.
...
/**
 * Setter for labels overlaps mode.
